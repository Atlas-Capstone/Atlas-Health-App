...
ActiveRecord::Schema[7.0].define(version: 2023_01_26_223227) do
  ...
  create_table "exercise_routines", force: :cascade do |t|
    ...
    t.index ["schedule_id"], name: "index_exercise_routines_on_schedule_id"
  end
  ...
  add_foreign_key "exercise_routines", "schedules"

...
const NewSchedule = ({ createSchedule, logged_in, current_user }) => {
  ...
  return (
    ...
    <label htmlFor="days_per_week" className="block">
      ...
      <input type="text" name="days_per_week" className="block text-sm font-md leading-5 text-[#4F4F4F] rounded-full" onChange={handleChange} value={newSchedule.days_of_week} />
    </label>

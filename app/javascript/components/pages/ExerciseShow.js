  ...
  <>
   { currentExercise && (
    <div>
      ...
      <h1 className="text-white text-2xl font-mono">{currentExercise.name}</h1>
          ...
          className="text-white items-center justify-center bg-opacity-50 bg-gray-500 rounded-2xl flex flex-col">
            ...
            <iframe className="rounded-t-2xl w-full min-h-[250px]" src={currentExercise.video} title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>  
